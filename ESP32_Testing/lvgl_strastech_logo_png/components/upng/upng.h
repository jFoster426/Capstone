...
void upng_rgb24bto18b(struct upng_s_rgb18b *dst, struct upng_s_rgb24b *src); //Converts 24bit-color(r8,g8,b8) into 18bit-color(r6,g6,b6)
void upng_rgb24bto16b(struct upng_s_rgb16b *dst, struct upng_s_rgb24b *src); //Converts 24bit-color(r8,g8,b8) into 16bit-color(r5,g6,b5)
